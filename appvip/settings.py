"""
Django settings for appvip project.
...
SECRET_KEY = '$g$%hey_*$+md!bm1t+-p9!c^y#kv3l1su(een45521@v78q&w'
...
WSGI_APPLICATION = 'appvip.wsgi.application'
