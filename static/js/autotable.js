...
function getTheme(name) {
    var themes = {
        'striped': {
            ...
            head: { textColor: 255, fillColor: [27, 58, 82], fontStyle: 'bold' },
            body: {},
            foot: { textColor: 255, fillColor: [27, 58, 82], fontStyle: 'bold' },
            alternateRow: { fillColor: 245 }
        },
        'grid': {
            table: { fillColor: 255, textColor: 80, fontStyle: 'normal', lineWidth: 0.1 },
            head: { textColor: 255, fillColor: [27, 58, 82], fontStyle: 'bold', lineWidth: 0 },
            body: {},
            foot: { textColor: 255, fillColor: [27, 58, 82], fontStyle: 'bold', lineWidth: 0 },
            alternateRow: {}
        },
        'plain': {
            head: { fontStyle: 'bold' },
